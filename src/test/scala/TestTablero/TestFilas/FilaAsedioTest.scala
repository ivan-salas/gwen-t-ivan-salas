...
class FilaAsedioTest extends FunSuite {
  ...
  override def beforeEach(context: BeforeEach): Unit = {
    val carta1: Carta = new CartaAsedio("Hanuman", 50)
    val carta2: Carta = new CartaAsedio("Pikachu", 40)
    val carta3: Carta = new CartaAsedio("Charizard", 30)
    val carta4: Carta = new CartaAsedio("Bulbasaur", 20)
