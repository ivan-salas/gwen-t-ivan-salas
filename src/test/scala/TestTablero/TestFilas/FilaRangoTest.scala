...
class FilaRangoTest extends FunSuite {
  ...
  override def beforeEach(context: BeforeEach): Unit = {
    val carta1: Carta = new CartaRango("Hanuman", 50)
    val carta2: Carta = new CartaRango("Pikachu", 40)
    val carta3: Carta = new CartaRango("Charizard", 30)
    val carta4: Carta = new CartaRango("Bulbasaur", 20)
