...
class FilaCuerpoCuerpoTest extends FunSuite {
  ...
  override def beforeEach(context: BeforeEach): Unit = {
    val carta1: Carta = new CartaCuerpoCuerpo("Hanuman", 50,0)
    val carta2: Carta = new CartaCuerpoCuerpo("Pikachu", 40,0)
    val carta3: Carta = new CartaCuerpoCuerpo("Charizard", 30,0)
    val carta4: Carta = new CartaCuerpoCuerpo("Bulbasaur", 20,0)
